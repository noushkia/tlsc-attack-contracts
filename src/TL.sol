...
contract MoneyMakingOpportunity is ERC721 {
    ...
    uint256 public constant FAIR_CONTRIBUTION = 0.03 ether;
    ...
    receive() external payable {
        ...
        if (
            ...
            payable(settlementAddressProposals[currentWeek()]).transfer(
    ...
    function proposeSettlementAddress(
        uint256 week,
    ...
    function settlePayment() external {
        ...
        payable(settlementAddressProposals[week]).transfer(
            address(this).balance
        );
